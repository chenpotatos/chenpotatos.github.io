...
export const Settings = () => {
    ...
    return ( <
        div className = "settingsApp floatTab dpShad"
        data - size = {
            wnapp.size
        }
        data - max = {
        ...
        <
        img src = "img/settings/defAccount.webp"
        alt = ""
        height = {
            60
        }
                                ...
                                switch (e.type) {
                                    case "sysTop":
                                        return ( <
                                            ...
                                            <
                                            img src = "https://upload.wikimedia.org/wikipedia/commons/9/94/M_box.svg"
                                            height = {
                                                20
                                            }
                                            alt = "" /
                                            ...
                                            <
                                            img src = "img/settings/Windows Update.webp"
                                            alt = ""
                                            height = {
                                                20
                                            }
                                    ...
                                    case "langSwitcher":
                                        return ( <
                                            ...
                                            Windows features like Settings and File Explorer will appear in this language <
                                            /p> <
                                            /div> <
                                            LangSwitch / >
                                            <
                                    ...
                                    case "updateTop":
                                        return ( <
                                            ...
                                            div className = "left" >
                                            <
                                            img src = "img/settings/update.png"
                                            width = {
                                                90
                                            }
                                            alt = "" /
