        ...
        return ( <
                ...
                const DownPage = ({
                    ...
                    return ( <
                        ...
                        className = "catbtn"
                        target = "_blank"
                        rel = "noreferrer" > Add your own app < /a> <
                        /div> <
                        /div> <
                                            ...
                                            dstate == 1 ? < div className = "downbar mt-12 mb-8" > < /div>:null} {
                                                ...
                                                onClick = {
                                                    ...
                                                    onClick = {
                                                        ...
                                                        Icon className = "text-orange-600 ml-1"
                                                    fafa = "faStar"
                                                    width = {
                                                        14
                                                    }
                                                    ...
                                                    K < /div> <
                                                        ...
                                                        div className = "text-xs mt-4" > < pre > {
                                                            app.data.desc
                                                        } < /pre></div >
                                                        <
                                                        /div> <
                                                        ...
                                                        div className = "text-xss ml-6" > {
                                                            "54321".split("").map((x, i) => {
                                                                return ( <
                                                                    ...
                                                                    Icon className = "text-orange-500 ml-1"
                                                                    fafa = "faStar"
                                                                    width = {
                                                                        8
                                                                    }
