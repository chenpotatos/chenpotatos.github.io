...
const NavTitle = (props) => {
    ...
    return ( <
        div className = "navtitle flex prtclk"
        data - action = {
            props.action
        }
        data - payload = {
...
const Dropdown = (props) => {
        ...
        return ( <
                ...
                <
                div className = "droptitle" > {!props.notoggle ? ( <
                        Icon className = "arrUi"
                        fafa = {
                        ...
                        pr / >
                    ) : < Icon className = "arrUi opacity-0"
                    fafa = "faCircle"
                    width = {
                        10
                    }
                    ...
                    action = {
                        props.action != "" ? (props.action || "FILEDIR") : null
                    }
                    payload = {
                        fid
                    }
                ...
                export const Explorer = () => {
                    ...
                    const DirCont = () => {
                        ...
                        arr.push( <
                            ...
                            className = "dirCont flex items-center" >
                            <
                            Icon className = "pr-1 pb-px"
                            src = {
                                "win/" + fdata.info.icon + "-sm"
                            }
                            width = {
                                16
                            }
                    ...
                    return ( <
                        ...
                        <
                        Icon className = {
                            "navIcon hvtheme" + ((files.hid + 1) == files.hist.length ? " disableIt" : "")
                        }
                        fafa = "faArrowRight"
                        width = {
                            14
                        ...
                        pr / >
                        <
                        Icon className = "navIcon hvtheme"
                        fafa = "faArrowUp"
                        width = {
                            14
                        }
                        ...
                        <
                        Icon className = "viewicon hvtheme p-1"
                        click = "FILEVIEW"
                        payload = "5"
                        open = {
                            files.view == 5
                ...
                const NavPane = ({}) => {
                    ...
                    return ( <
                        ...
                        <
                        /Dropdown> <
                        Dropdown icon = "onedrive"
                        title = "OneDrive"
                        spid = "%onedrive%" / >
                        <
                        Dropdown icon = "thispc"
                        title = "This PC"
                        action = ""
                        isDropped >
                        <
