...
export const StartMenu = () => {
    const {
        align
    } = useSelector((state) => state.taskbar);
    ...
    return ( <
        div className = "startMenu dpShad"
        data - hide = {
            start.hide
        }
        style = {
        ...
        data - align = {
            ...
            start.menu ? ( <
                ...
                /div> <
                /div> <
                div className = "allApps win11Scroll"
                data - alpha = {
                    start.alpha
                } > {
                    start.contApps.map((ldx, i) => {
                        ...
                        tpApps.push( <
                            ...
                            id = {
                                `char${i === 0 ? "#" : String.fromCharCode(i + 64)}`
                            } >
                            <
                ...
                /div> {
                    start.contApps.map((ldx, i) => {
                        return ( <
                            ...
                            data - action = "STARTALPHA"
                            onClick = {
                                ldx.length === 0 ? null : clickDispatch
                            }
                            data - payload = {
                                i === 0 ? "#" : String.fromCharCode(i + 64)
                            } >
                ...
                <
                div className = "flex prtclk"
                onClick = {
                    clickDispatch
                }
                data - action = "WALLSHUTDN" >
                <
                Icon msi = "PowerButton"
                width = {
                    12
                }
                /> <
                ...
                <
                div className = "leftSide flex-col px-1"
                data - width = {
                    query.length !== 0
                } >
                <
                div className = "text-sm font-semibold mb-4" > {
                    ...
                    query.length ? ( <
                        ...
                        /div> <
                        /div> <
                        div className = "smatch flex my-2 p-3 rounded handcr prtclk"
                        onClick = {
                            clickDispatch
                        }
                        ...
                        div className = "topApps flex w-full justify-between" > {
                            start.rcApps.slice(1, 7).map((app, i) => {
                                return ( <
                                    ...
                                    className = "topApp pt-6 py-4 ltShad" >
                                    <
                                    Icon onClick = {
                                        clickDispatch
                                    }
                ...
                /div> {
                    query.length ? ( <
                        ...
                        data - payload = {
                            match.payload ? match.payload : "full"
                        } >
                        <
                        Icon className = "blueicon"
                        src = "link"
