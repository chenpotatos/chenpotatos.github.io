...
export const DesktopApp = () => {
    ...
    return ( <
        div className = "desktopCont" > {!deskApps.hide &&
...
export const SidePane = () => {
    ...
    return ( <
        ...
        /> <
        input className = "sliders bSlider"
        onChange = {
            setBrightness
        }
        type = "range"
        ...
        /> <
        input className = "sliders vSlider"
        onChange = {
            setVolume
        }
        type = "range"
...
export const CalnWid = () => {
    ...
    return ( <
        ...
        /div> <
        div className = "collapser p-2 m-4 rounded"
        onClick = {
            collapseToggler
        } > {
            collapse === "" ? ( <
