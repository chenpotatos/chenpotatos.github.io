...
export const WidPane = () => {
        ...
        return ( <
            ...
            <
            Icon src = {
                `https://www.metaweather.com/static/img/weather/png/64/${widget.data.weather.icon}.png`
            }
            ext width = {
                32
            }
            ...
            div className = "weekWthCont" > {
                widget.data.weather.days.map((item, i) => {
                    return ( <
                        ...
                        Icon src = {
                            `https://www.metaweather.com/static/img/weather/png/64/${item.icon}.png`
                        }
                        ext width = {
                            24
                        }
            ...
            div className = "allNewsCont" > {
                [...widget.data.news].splice(4, widget.data.news.length).map((article, i) => {
                        return ( <
                            a className = "articleCont ltShad"
                            target = "_blank"
                            style = {
                                {
