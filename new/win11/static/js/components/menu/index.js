                                            ...
                                            data - payload = {
                                                ...
                                                menudata.ispace != false ? ( <
                                                    div className = "spcont" > {
                                                        opt.icon && opt.type == "svg" ? < Icon icon = {
                                                            opt.icon
                                                        }
                                                        width = {
                                                            16
                                                        ...
                                                        /> : null} {
                                                            opt.icon && opt.type == "fa" ? < Icon fafa = {
                                                                opt.icon
                                                            }
                                                            width = {
                                                                16
                                                            ...
                                                            /> : null} {
                                                                opt.icon && opt.type == null ? < Icon src = {
                                                                    opt.icon
                                                                }
                                                                width = {
                                                                    16
                                                        ...
                                                        div className = "nopt" > {
                                                            ...
                                                            opt.opts ? < Icon className = "micon rightIcon"
                                                            fafa = "faChevronRight"
                                                            width = {
                                                                10
                                                            }
                                                            ...
                                                            opt.dot ? < Icon className = "micon dotIcon"
                                                            fafa = "faCircle"
                                                            width = {
                                                                4
                                                            }
                                                            ...
                                                            /> : null} {
                                                                opt.check ? < Icon className = "micon checkIcon"
                                                                fafa = "faCheck"
                                                                width = {
                                                                    8
                                                                }
                                                                ...
                                                                /> : null} {
                                                                    opt.opts ? < div className = "minimenu"
                                                                    style = {
                                                                            {
