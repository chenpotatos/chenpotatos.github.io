...
export const Icon = (props) => {
    ...
    if (props.fafa != null) {
        ...
        return ( <
            ...
            onClick = {
                props.onClick || (props.pr && clickDispatch) || null
            }
            data - menu = {
                props.menu
            }
            data - pr = {
                ...
                div
                onClick = {
                    props.click != null ? clickDispatch : null
                }
                style = {
                    {
                        width: props.width,
...
export const Image = (props) => {
        ...
        return ( <
            div className = {
                `imageCont prtclk ${props.className||""}`
            }
            id = {
                props.id
            }
            ...
            onClick = {
                props.onClick || (props.click && clickDispatch)
            }
            data - action = {
                props.click
            }
        ...
        export const ToolBar = (props) => {
            ...
            return ( <
                ...
                payload = "mxmz"
                src = {
                    props.size == "full" ? "maximize" : "maxmin"
                }
                /> <
                SnapScreen invert = {
                    props.invert
                ...
                div className = "flex" >
                <
                div className = "conrsz cursor-nw"
                data - op = "1"
                onMouseDown = {
                    toolDrag
                }
                data - vec = "-1,-1" > < /div> <
                div className = "edgrsz cursor-n wdws"
                data - op = "1"
                onMouseDown = {
                    toolDrag
                }
                ...
                <
                div className = "edgrsz cursor-w hdws"
                data - op = "1"
                onMouseDown = {
                    toolDrag
                }
                ...
                div className = "flex" >
                <
                div className = "conrsz cursor-ne"
                data - op = "1"
                onMouseDown = {
                    toolDrag
                }
