            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown active">
                ...
                <ul class="dropdown-menu multilevel scale-up-left">
                  ...
                  <li class="nav-item"><a class="nav-link active" href="<?php echo U('tools/menu');?>">导航管理</a></li>            
                </ul>                 
              </li> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">新增导航</li>
      </ol>
    </section>
    ...
    <div class="row">
            ...
            <div class="box-header with-border">
              <h4 class="box-title"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">发布一个新的首页导航</font></font></h4>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form id="f" enctype="multipart/form-data" class="form-horizontal form-element">
              <div class="box-body">
                <div class="form-group row">
                  <label for="inputEmail3" class="col-sm-2 control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">导航标题</font></font></label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="name" name="name" placeholder="为了让更多的人点击它，给你的应用起一个响亮的标题">
                  </div>
                </div>
              	<div class="form-group row">
                  <label for="inputEmail3" class="col-sm-2 control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">导航链接</font></font></label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="link" name="link" placeholder="请填写带http：//或者https://的完整域名">
                  </div>
                </div>
                
                <div class="form-group row">
                  <label for="inputEmail3" class="col-sm-2 control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">导航描述</font></font></label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="desc" name="desc" placeholder="导航描述">
                  </div>
                </div>
	...
	<script type="text/javascript">
        ...
        if (desc =='') {
          layer.msg('请输入导航描述！', function () {
			...
			if (e == 0) {
            $.post("<?php echo U('tools/menuadd');?>", {name: name, link: link,desc:desc}, function (data) {
              var index = layer.load(1, {shade: false}); //0代表加载的风格，支持0-2
                if (data.status == '1') {
