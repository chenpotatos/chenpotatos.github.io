  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
            ...
            <div class="box-header with-border">
            <a href="<?php echo U('tools/menuadd');?>" class="btn btn-outline btn-rounded btn-info">新增一个导航</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
				  ...
				  <table id="example1" class="table table-bordered table-striped">
					<thead>
						<tr>
							...
							<th><span class="badge badge-info">导航名称</span></th>
							<th><span class="badge badge-warning">导航链接</span></th>
              <th><span class="badge badge-secondary">导航描述</span></th>
					...
					<tbody>
						<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							...
							<td><a href="<?php echo ($vo["link"]); ?>" target="_blank"><?php echo ($vo["link"]); ?>点击查看该站点</a></td>
              <td><?php echo ($vo["descc"]); ?></td>
							 <td>
								<a href="<?php echo U('tools/menuedit');?>?id=<?php echo ($vo["id"]); ?>" class="btn btn-outline btn-rounded btn-primary">编辑</a>
                <a href="javascript:void(0)" onClick="ty_del(this,'<?php echo ($vo["id"]); ?>')"  class="btn btn-outline btn-rounded btn-danger">删除</a>
							</td>
...
<!-- ./wrapper -->
	...
	<script type="text/javascript">
		function ty_del(obj, id) {
            var id = id;
            layer.confirm('确定要删除该导航吗？注意此操作不可逆！', function (index) {

                $.ajax({
                    type: 'POST',
                    url: '<?php echo U('tools/menudel');?>',
                    dataType: 'json',
                    data: { id: id},
