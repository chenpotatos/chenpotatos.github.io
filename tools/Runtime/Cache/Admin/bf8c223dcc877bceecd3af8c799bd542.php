  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">编辑导航</li>
      </ol>
    </section>
    ...
    <div class="row">
            ...
            <div class="box-header with-border">
              <h4 class="box-title"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">编辑一个导航/font></font></h4>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form id="f" enctype="multipart/form-data" class="form-horizontal form-element">
              <div class="box-body">
                <div class="form-group row">
                  <label for="inputEmail3" class="col-sm-2 control-label">导航标题</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="name" name="name" placeholder="为了让更多的人点击它，给你的应用起一个响亮的标题" value="<?php echo ($info["menu"]); ?>">
                  </div>
                </div>
              	<div class="form-group row">
                  <label for="inputEmail3" class="col-sm-2 control-label">导航链接</label>
                ...
                <div class="form-group row">
                  <label for="inputEmail3" class="col-sm-2 control-label">导航描述</label>
	...
	<script type="text/javascript">
        ...
        if (desc =='') {
          layer.msg('请输入站点描述！', function () {
			...
			if (e == 0) {
            $.post("<?php echo U('tools/menuedit');?>", {id:id,name: name, link: link,desc:desc}, function (data) {
              var index = layer.load(1, {shade: false}); //0代表加载的风格，支持0-2
                if (data.status == '1') {
