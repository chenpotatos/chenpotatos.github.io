  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
            ...
            <div class="box-header with-border">
            <a href="<?php echo U('tools/linkadd');?>" class="btn btn-outline btn-rounded btn-info">新增一个友链</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
				  ...
				  <table id="example1" class="table table-bordered table-striped">
					<thead>
						<tr>
							...
							<th><span class="badge badge-info">站点名称</span></th>
							<th><span class="badge badge-warning">站点链接</span></th>
              <th><span class="badge badge-secondary">站点描述</span></th>
              ...
              <td><?php echo ($vo["descc"]); ?></td>
							 <td>
								<a href="<?php echo U('tools/linkedit');?>?id=<?php echo ($vo["id"]); ?>" class="btn btn-outline btn-rounded btn-primary">编辑</a>
...
<!-- ./wrapper -->
	...
	<script type="text/javascript">
		function ty_del(obj, id) {
            var id = id;
            layer.confirm('确定要删除该友链吗？注意此操作不可逆！', function (index) {

                $.ajax({
                    type: 'POST',
                    url: '<?php echo U('tools/linkdel');?>',
                    dataType: 'json',
                    data: { id: id},
