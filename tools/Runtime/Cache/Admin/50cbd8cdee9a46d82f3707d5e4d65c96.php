...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
		...
		<div class="row">
      <?php if(is_array($temp)): $i = 0; $__LIST__ = $temp;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tp): $mod = ($i % 2 );++$i;?><div class="col-md-12 col-lg-4">
        <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title d-block text-center"><?php echo ($tp["name"]); ?></h3>          
        </div>
        <div class="box-body">
            <a class="d-block" href="coming-soon-2.html" target="_blank">
            <img src="<?php echo ($tp["img"]); ?>" alt="Verify Emial page" style="width: 100%;height:100% ">
          </a>
        </div>
        <!-- /.box-body -->
        <div class="box-footer">

                <?php if($nowtemp == $tp['url']): ?><button type="button" id="classedit" class="btn btn-secondary pull-right">当前主题</button>
                  <?php else: ?> 
                  <input type="hidden" id="tempval" value="<?php echo ($tp["url"]); ?>">
                  <button type="button" id="usetemp" class="btn btn-info pull-right">应用主题</button><?php endif; ?>
...
<!-- ./wrapper -->
   ...
   $("#usetemp").click(function () {
        ...
        if (e == 0) {
            $.post("<?php echo U('system/usetemp');?>", { te:te}, function (data) {
